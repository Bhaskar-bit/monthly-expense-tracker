      ...
      <CardContent className="space-y-5">
        <div className="space-y-2">
          ...
          {isEditing ? (
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 p-4 rounded-lg bg-primary/5 border border-primary/10">
              <p className="text-2xl sm:text-3xl font-bold text-primary break-words">{formatAmount(inflow)}</p>
              <Button
                size="icon"
                variant="ghost"
                onClick={() => {
